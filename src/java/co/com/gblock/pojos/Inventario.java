...
public class Inventario implements Serializable {
    ...
    public Inventario(InventarioPK inventarioPK, Integer cantidad, Integer stockMax, Integer stockMin, Integer stockAlerta, Short estado, Bodega bodega, Articulo articulo) {
