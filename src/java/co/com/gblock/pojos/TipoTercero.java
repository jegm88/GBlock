...
public class TipoTercero implements Serializable {
    ...
    public TipoTercero(Integer id, String nombre, String descripcion, Short estado) {
        this.id = id;
        this.nombre = nombre;
    ...
    public int hashCode() {
        ...
        hash = 13 * hash + (this.descripcion != null ? this.descripcion.hashCode() : 0);
    ...
    public String toString() {
        return "TipoTercero{" + "id=" + id + ", nombre=" + nombre + ", descripcion=" + descripcion + ", estado=" + estado + '}';
    }
    //</editor-fold>
