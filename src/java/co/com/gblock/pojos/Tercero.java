...
public class Tercero implements Serializable {
    ...
    public Tercero(String id, String tipoId, Short digitoVerificacion, String nombres, String apellidos, String direccion, Short estado, List<Telefono> telefonos, TipoTercero tipo, List<Correo> correos) {
        this.id = id;
        this.tipoId = tipoId;
